...
function Aside() {
    return (
        <aside className="sticky top-0 left-0 w-1/5 z-10 bg-[#1c2434] h-screen text-[#d2d8e2] items-center justify-around p-4">
            {/* brand logo  */}
            <div className=" my-3">
            ...
            <div className="mt-7 p-3">
                <div>
                    <ul>
                        <li className=" justify-center pl-7 p-2  mx-5 my-3 text-white hover:bg-white hover:text-blue-950 hover:rounded-lg" >
