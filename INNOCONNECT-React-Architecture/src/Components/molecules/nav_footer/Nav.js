        ...
        <>
          <div className='mx-auto max-w-[1440px] px-2 py-3 sm:px-6 lg:px-8'>
            <div className='relative flex h-16 items-center justify-between'>
              ...
              <Link
                to='/login'
                className='inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-4 py-2  text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50'
              >
                Login
              </Link>
              <Link
                to='/register'
                className='inline-flex w-full justify-center gap-x-1.5 rounded-md bg-secondary-06 px-4 py-2  text-white shadow-sm active:bg-secondary-07 hover:shadow-btn'
              >
                Register
              </Link>
              </div>
