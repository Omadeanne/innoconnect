  ...
  return (
    <main className='darkmode:bg-gray-900'>
      <div className='flex relative'>
        ...
        <div className='h-screen bg-gray-200 overflow-auto w-full'>
          <Header />
          <div>
            <div
              className='px-6 mb-4 z-0 snap-x'
            >
              <div className='grid md:grid-cols-3 text-primary-05 sm:grid-cols-1 gap-6 my-4 py-2 text-center snap-x'>
                ...
                <div className='w-full md:w-2/5 bg-white flex flex-col shadow-md'>
                  ...
                  <div className='p-4 border-b border-b-slate-300'>
                    <div className='flex items-center'>
                      ...
                      <p className='ml-3 text-sm'>
                        <span className='font-medium'>Elizabeth Okwong</span>{' '}
                        applied for a
                        <a
                          href='#'
                          className='font-medium text-secondary-04'
                  ...
                  <div className='p-4 border-b border-b-slate-300'>
                    <div className='flex items-center'>
                      ...
                      <p className='ml-3 text-sm'>
                        <span className='font-medium'>Edet Effiong</span> sent
                        you a message
                      </p>
                    </div>
                  </div>
