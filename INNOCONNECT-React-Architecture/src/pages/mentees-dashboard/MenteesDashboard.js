        ...
        <div className="px-6 z-0 snap-x">
          ...
          <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-6 my-4 py-2 text-center snap-x">
            <div className="bg-[#ffffff] rounded-lg py-10 h-40 pr-10 pl-10 hover:bg-[#1C2434] hover:text-white snap-center">
              <h2 className="rounded-full text-xl text-center font-semibold ">A</h2>
              <p className="font-semibold">Adobe Suit and Pack</p>
            </div>
            <div className="bg-[#ffffff] rounded-lg py-10 h-40 pr-10 pl-10 hover:bg-[#1C2434] hover:text-white snap-center">
              <h2 className="rounded-full text-xl text-center font-semibold ">B</h2>
              <p className="font-semibold ">Basic HTML and CSS</p>
            </div>
            <div className="bg-[#ffffff] rounded-lg py-10 h-40 pr-10 pl-10 hover:bg-[#1C2434] hover:text-white snap-center">
              <h2 className="rounded-full text-xl text-center font-semibold ">C</h2>
            ...
            <div className=" md:w-2/5 relative bg-card text-zinc-700 rounded-md p-4 divide-y divide-slate-300">
              ...
              <div className="flex justify-between flex-col">
                ...
                <div className="flex justify-between items-center gap-4">
                  <input type="text" id="taskInput" className="border-b border-b-black mt-2 w-full" placeholder="Add a new to-do item..." />
                  <button type="button" onclick="addTask()" className><i className="fa-solid fa-plus" /></button>
                </div>
                <ul id="taskList" />
              </div>
            </div>
          ...
          <div className="flex justify-evenly bg-white mt-8 mb-14 py-5 rounded-md">
            <div className>
              <img className="max-h-96" src="./assets/upcoming-meetings.png" alt />
            </div>
            <div>
              <img className="max-h-96 max-w-5xl" src="./assets/interview.png" alt />
            </div>
          </div>
        </div>
      </div>
