  ...
  return (
    <div>
            ...
            <div className='w-full md:w-2/5'>
              <div className>
                ...
                <div className="inline-block w-full">
                  <form action="" id="search-form" className="w-full flex gap-4">
                    <div className="relative inline-block ">
                      <input className="md:max-w-sm rounded px-2 py-1 placeholder:text-base focus:outline-none" type="text" placeholder="Search" aria-label="Search" id="search-input"/>
                      <i className="absolute right-2 top-[0.4rem] text-primary-06 opacity-70 text-sm fa-solid fa-magnifying-glass"></i>
                    </div>
                    <button type="submit"className="bg-white inline-block rounded-3xl text-sm hover:text-white text-primary-06 py-1 px-4 hover:bg-[#6A95B1] transition-all">Search</button>
                  </form>
                </div>
              </div>
            </div>
            ...
            <div className='flex flex-col md:flex-row gap-10 px-4'>
              ...
              <div className='w-full md:w-2/5'>
                ...
                <div className='flex items-center mt-8 font-medium'>
                  <img  className='rounded-full h-10 w-10' src="https://i.ibb.co/5XDGCHJ/lizzy.jpg" alt="lizzy" border="0" />
      ...
      <div>
        <div className="flex items-center text-error-04 font-medium mb-3">
          ...
          <i className="fa-solid fa-circle text-[0.4rem] mx-2 opacity-50"></i>
          <p className="">4 mins read</p>
        </div>
        <h2 className="text-xl md:text-3xl font-bold text-primary-06">Roadmap for Transitioning to Data Analytics</h2>
        <p className="my-4">
        You may have a university degree in an unrelated field, or have been working in a completely different domain. You may be interested in transitioning into a data analysis role for a while, but do not know where to start. If this sounds like you, keep on reading! 😉<span><a href="https://medium.com/towards-data-science/how-to-transition-to-data-analytics-128a3dca54d5"
              className="text-error-04 font-medium"> Read more...</a>
          </span>
        </p>
        <hr/>
        <div className="flex items-center mt-4 font-medium">
          <img className="rounded-full h-10 w-10" src="https://i.ibb.co/5XDGCHJ/lizzy.jpg" alt="lizzy" border="0" />
          <p className="ml-2">Elizbeth Okwong</p>
          <i className="fa-solid fa-circle text-[0.4rem] mx-2 opacity-50 text-primary-05"></i>
          <p className="">20th July, 2022</p>
        </div>
      </div>
    </div>
    <div className="flex flex-col gap-4">
      ...
      <div>
        ...
        <h2 className="text-xl md:text-3xl font-bold text-primary-06">Maximizing Mentorship: Essential Questions to Ask Your Mentor</h2>
        <p className="my-4">
        Mentorship is an essential component of career development. Having someone who can guide you and provide you with insights based on their experiences can significantly accelerate your progress towards...<span><a href="https://medium.com/pm101/maximizing-mentorship-essential-questions-to-ask-your-mentor-d3f5d63bc5a5"
              className="text-red-400 font-medium"> Read more</a>
          </span>
        </p>
        <hr/>
        <div className="flex items-center mt-4 font-medium">
    ...
    <div className="flex flex-col gap-4">
      ...
      <div>
        ...
        <h2 className="text-xl md:text-3xl font-bold text-primary-06">Mastering Emotional Intelligence: The Key to Success and Well-being</h2>
        <p className="my-4">
        In the realm of personal and professional development, few skills hold as much importance as emotional intelligence (EI). This nuanced and often underestimated trait has the power to shape not only our relationships but also our careers, mental health, and overall quality of life.<span><a href="https://medium.com/@tjohnson34452/mastering-emotional-intelligence-the-key-to-success-and-well-being-e5653a3b82d5"
              className="text-error-04 font-medium">Read
              more</a>
          </span>
        </p>
        <hr/>
        <div className="flex items-center mt-4 font-medium">
        <img className="rounded-full h-10 w-10" src="https://i.ibb.co/Ryw1frn/dan.jpg" alt="dan" border="0" />
