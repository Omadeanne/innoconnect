    ...
    <section className="bg-primary-05 px-4 py-5">
      <div className="container md:h-[500px] mx-auto flex flex-col-reverse md:flex-row justify-center items-center gap-10">
        <div className="w-full md:w-2/5">
          <div className>
            <h1 className="text-3xl md:text-5xl text-white font-bold font-sans">Our Blog</h1>
            <p className="text-xl text-white my-4 max-w-lg">A center for all our Resources and insights.Get the best of
              mentorship and career news, internship and land the dream job</p>
        ...
        <div className="w-full md:w-[30rem]">
          <img src="/assets/blog_illustration.svg" className="w-full object-cover" alt="blog" />
        </div>
      </div>
    </section>
    <div id="content">
      <section className="mt-8" id="featured">
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 px-4">
          <div className>
            <img src="./assets/carr.jpg" className="rounded-xl" alt="thumbnail" />
          </div>
          <div className="w-full md:w-2/5">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-primary-06 mt-4">Are unpaid internships <br /> worth it?</h2>
            <p className="mt-4">In the fast-paced, ever-evolving landscape of the modern workplace,
      ...
      <section className="mt-20">
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 px-4" id="blogList">
